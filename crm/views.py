...
def customer_export(request):
    ...
    template_name = "customer_export.html"
...
def register(response):
    ...
    return render(response, "crm/register.html", {"form": form})

def password(response):
    if response.method == "POST":
        form = PasswordForm(response.POST)
        if form.is_valid():
            form.save()
        return redirect("/home")
    else:
    ...
    return render(response, "crm/password_reset_form.html", {"form": form})
